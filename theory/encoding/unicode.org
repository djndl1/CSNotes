...
The process of /assigning numbers (code points) to graphical characters/. All
these code points make up a /code space/, /code page/ (originally coded in
...
- /glyph/: a specific shape that represents any particular grapheme in a given typeface.

...
Unguided optical signaling is inheritly unidirectional, offers very high
bandwidth at very low cost and is easy to install.

It is difficuilt to align the transmitter and the receiver and the beam is susceptible to

...
- *Collating symbols* =[.CollatingSymbol.]= a multicharacter sequence treated as a unit

- *Equivalence classes* ~[\=, \=]~: a set of characters that should be considered equivalent.
...
- =autoindent= :: supply indentation automatically; useful for programming

...
dotnet 8.0, 9.0 and 10.0, mono are in the repository.

** Java

OpenJDK, Kotlin, Scala.
...
There is no official support due to Bun not being available on Bionic Termux.
This is [[https://github.com/Hope2333/opencode-termux][some work]] that runs OpenCode in the glibc environment on Termux.

...
where
$c_n=\dfrac{1}{T}\int\limits^{T/2}_{-T/2}f(t)e^{-j\frac{2\pi n}{T}t}dt\qquad for\qquad n=0,\pm1,\pm2,...$
...
e.g. $H(u,v)=0\qquad for\qquad u=v=0\$ otherwise $1$ reduces the average intensity

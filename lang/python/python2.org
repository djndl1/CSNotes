...
The fixers provided by the following tools are also a guide to port Python 2 code to Python 3.

** lib2to3

Built in Python until 3.13

** [[https://github.com/PyCQA/modernize][modernize]]

Reads Python 2 code and applies a series of /fixers/ to transform it into code compatible with both Python 3 and Python 2.7

** [[https://pypi.org/project/pyupgrade/][pyupgrade]]

Convert code compatible with Python 2 and Python 3 to full Python 3 without backwards-compatibility.

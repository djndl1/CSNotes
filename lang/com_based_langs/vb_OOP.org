...
- [[https://learn.microsoft.com/en-us/dotnet/visual-basic/language-reference/modifiers/withevents][=WithEvents=]]:
  ...
  #+begin_src  vba
' this variable A is of the specified type
' with its events handled in this module by functions of A_ClassEventName
Private WithEvents A As class_type_with_events
  #+end_src

...
that is, they are both lists of words, numbers, or other lists, separated by whitespace and surrounded by parentheses.
...
- quote: if a list or symbol is not quoted, it is evaluated.

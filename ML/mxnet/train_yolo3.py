...
class petVOC(VOCDetection):
    CLASSES = ['drone', 'else']
    def __init__(self, root=os.path.join('~','Datasets','simul_drones'), 
...
def parse_args():
    ...
    parser.add_argument('--no-random-shape', default=True, action='store_true',
...
if __name__ == '__main__':
    ...
    if args.syncbn and len(ctx) > 1:
        ...
        net = get_model(net_name, pretrained_base=True, classes=('drone', 'else'))
        async_net = net

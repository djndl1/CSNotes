...
If the client session specifies a different character from the server's,
...
Use =AL32UTF8= (as the database character set) and =AL16UTF16= (as the national character set so that a database
